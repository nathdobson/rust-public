use crate::gui_old::node::{Node, NodeImpl, NodeHeader};
    ...
    pub fn new() -> Node<Panel> {
        Self::new_internal(|header| {
            Panel {
                ...
                outline: TableBorder::default(),
            }
        })
    }
    pub fn set_outline(&mut self, outline: TableBorder) {
