...
impl<'a> BinarySerializer<'a> {
    pub fn new(vec: &'a mut Vec<u8>) -> Self { BinarySerializer { vec } }
...
impl<'a> Serializer for BinarySerializer<'a> {
    ...
    fn serialize_bool(mut self, v: bool) -> Result<()> { self.serialize_raw(&[v as u8]) }
    fn serialize_i8(mut self, v: i8) -> Result<()> { self.serialize_raw(&v.to_le_bytes()) }
    fn serialize_i16(mut self, v: i16) -> Result<()> { self.serialize_raw(&v.to_le_bytes()) }
    fn serialize_i32(mut self, v: i32) -> Result<()> { self.serialize_raw(&v.to_le_bytes()) }
    fn serialize_i64(mut self, v: i64) -> Result<()> { self.serialize_raw(&v.to_le_bytes()) }
    fn serialize_i128(mut self, v: i128) -> Result<()> { self.serialize_raw(&v.to_le_bytes()) }
    fn serialize_u8(mut self, v: u8) -> Result<()> { self.serialize_raw(&v.to_le_bytes()) }
    fn serialize_u16(mut self, v: u16) -> Result<()> { self.serialize_raw(&v.to_le_bytes()) }
    fn serialize_u32(mut self, v: u32) -> Result<()> { self.serialize_raw(&v.to_le_bytes()) }
    fn serialize_u64(mut self, v: u64) -> Result<()> { self.serialize_raw(&v.to_le_bytes()) }
    fn serialize_u128(mut self, v: u128) -> Result<()> { self.serialize_raw(&v.to_le_bytes()) }
    fn serialize_f32(mut self, v: f32) -> Result<()> { self.serialize_raw(&v.to_le_bytes()) }
    fn serialize_f64(mut self, v: f64) -> Result<()> { self.serialize_raw(&v.to_le_bytes()) }
    fn serialize_char(mut self, v: char) -> Result<()> {
        self.serialize_raw(&(v as u32).to_le_bytes())
    }
    fn serialize_str(mut self, v: &str) -> Result<()> { self.serialize_bytes(v.as_bytes()) }
    fn serialize_bytes(mut self, v: &[u8]) -> Result<()> {
        self.reborrow().serialize_u64(v.len() as u64)?;
        self.serialize_raw(v)?;
        Ok(())
    }
    fn serialize_none(mut self) -> Result<()> { self.serialize_bool(false) }
    ...
    fn serialize_unit(mut self) -> Result<()> { Ok(()) }
    fn serialize_unit_struct(mut self, name: &'static str) -> Result<()> { Ok(()) }
    ...
    fn serialize_tuple(mut self, len: usize) -> Result<Self> { Ok(self) }
    fn serialize_tuple_struct(mut self, name: &'static str, len: usize) -> Result<Self> { Ok(self) }
    ...
    fn serialize_struct(mut self, name: &'static str, len: usize) -> Result<Self> { Ok(self) }
